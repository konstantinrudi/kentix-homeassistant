...
CONF_SHOW_ACCESS_MANAGERS = "show_access_managers"

DEFAULT_VERIFY_SSL = False
DEFAULT_SCAN_INTERVAL = 300
DEFAULT_MANAGE_WEBHOOK = True
DEFAULT_SHOW_ACCESS_MANAGERS = False
MIN_SCAN_INTERVAL = 5
...
DOOR_LOCK_TYPE_CODE = 21
ACCESS_MANAGER_TYPE_CODE = 105

KENTIX_WEBHOOK_NAME_PREFIX = "Home Assistant Kentix"
KENTIX_WEBHOOK_SCHEMA = "kentix_home_assistant_v2"
